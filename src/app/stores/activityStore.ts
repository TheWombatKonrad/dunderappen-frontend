...
export default class ActivityStore {
  ...
  // Gets us an two dimensional array, with first a date array followed by an activitiy array for each date
  ...
  private setActivity = (activity: Activity) => {
    ...
    if (user) {
      activity.isGoing = this.isUserAttending(activity, user);
  ...
  private isUserAttending(activity: Activity, user: User): boolean {
    return activity.attendees!.some(
